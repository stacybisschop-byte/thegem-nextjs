...
const doc = await client.fetch('*[_type == "article" && slug.current == "cartier-family-history"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_cartier-family-history.body.json", JSON.stringify(doc));
