...
const doc = await client.fetch('*[_type == "article" && slug.current == "best-signet-rings-men"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_best-signet-rings-men.body.json", JSON.stringify(doc));
