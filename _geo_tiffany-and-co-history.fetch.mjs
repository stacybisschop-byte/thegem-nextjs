...
const doc = await client.fetch('*[_type == "article" && slug.current == "tiffany-and-co-history"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_tiffany-and-co-history.body.json", JSON.stringify(doc));
