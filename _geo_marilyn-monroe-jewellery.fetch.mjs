...
const doc = await client.fetch('*[_type == "article" && slug.current == "marilyn-monroe-jewellery"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_marilyn-monroe-jewellery.body.json", JSON.stringify(doc));
