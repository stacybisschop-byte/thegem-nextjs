...
const doc = await client.fetch('*[_type == "article" && slug.current == "renaissance-pigment-stones"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_renaissance-pigment-stones.body.json", JSON.stringify(doc));
