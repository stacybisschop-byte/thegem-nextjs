/**
 * One-off: create the office jewellery styling piece, scheduled for its
 * 26 August 2026 launch date. Not published immediately — publishedAt is set
 ...
 * on/after that date.
 * Run: npx tsx scripts/publish-jewellery-office-styling.ts
 */
...
const SLUG = 'jewellery-office-styling'
const DOC_ID = `article-${SLUG}`
const LAUNCH_DATE = '2026-08-26'

async function main() {
  const file = join(__dirname, '../content/72-jewellery-office-styling.md')
  ...
  const doc = {
    ...
    heroImageUrl: 'https://images.unsplash.com/photo-1708220040828-9ab1673681d3?w=2400&q=80&fit=crop&crop=entropy',
    heroImageAlt: 'A pair of textured gold stud earrings on a plain white surface.',
    body,
