/**
 * One-off: create the Acrostic Rings guide, scheduled for its 16 August 2026
 ...
 * Run: npx tsx scripts/publish-acrostic-rings.ts
 */
...
const SLUG = 'acrostic-rings'
const DOC_ID = `article-${SLUG}`
const LAUNCH_DATE = '2026-08-16'

async function main() {
  const file = join(__dirname, '../content/74-acrostic-rings.md')
  ...
  const doc = {
    ...
    heroImageUrl: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=1600&q=85',
    heroImageAlt: 'An antique gold acrostic ring set with a row of coloured gemstones spelling a hidden word.',
    body,
