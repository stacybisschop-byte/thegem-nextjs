/**
 * One-off: create the best gold hoop earrings guide, scheduled for its
 * 10 August 2026 launch date. Not published immediately — publishedAt is set
 ...
 * on/after that date.
 * Run: npx tsx scripts/publish-best-gold-hoop-earrings.ts
 */
...
const SLUG = 'best-gold-hoop-earrings'
const DOC_ID = `article-${SLUG}`
const LAUNCH_DATE = '2026-08-10'

async function main() {
  const file = join(__dirname, '../content/66-best-gold-hoop-earrings.md')
  ...
  const doc = {
    ...
    heroImageUrl: 'https://images.unsplash.com/photo-1680968921717-4abbbe793bb3?w=2400&q=80&fit=crop&crop=entropy',
    heroImageAlt: 'A gold hoop earring shown in closeup against a white background.',
    body,
