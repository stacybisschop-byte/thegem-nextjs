...
const doc = await client.fetch('*[_type == "article" && slug.current == "princess-diana-jewellery"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_princess-diana-jewellery.body.json", JSON.stringify(doc));
