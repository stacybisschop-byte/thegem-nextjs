...
const doc = await client.fetch('*[_type == "article" && slug.current == "jewellery-that-holds-value"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_jewellery-that-holds-value.body.json", JSON.stringify(doc));
