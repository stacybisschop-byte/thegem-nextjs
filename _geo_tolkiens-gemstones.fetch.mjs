...
const doc = await client.fetch('*[_type == "article" && slug.current == "tolkiens-gemstones"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_tolkiens-gemstones.body.json", JSON.stringify(doc));
