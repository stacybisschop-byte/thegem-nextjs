...
const doc = await client.fetch('*[_type == "article" && slug.current == "layering-necklaces"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_layering-necklaces.body.json", JSON.stringify(doc));
