...
const doc = await client.fetch('*[_type == "article" && slug.current == "engagement-ring-stones"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_engagement-ring-stones.body.json", JSON.stringify(doc));
