...
const doc = await client.fetch('*[_type == "article" && slug.current == "lab-grown-vs-natural-diamonds"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_lab-grown-vs-natural-diamonds.body.json", JSON.stringify(doc));
