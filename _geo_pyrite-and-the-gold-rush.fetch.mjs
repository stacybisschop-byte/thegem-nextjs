...
const doc = await client.fetch('*[_type == "article" && slug.current == "pyrite-and-the-gold-rush"][0]{ _id, body }');
writeFileSync("C:/Users/stacy/projects/thegem-nextjs/_geo_pyrite-and-the-gold-rush.body.json", JSON.stringify(doc));
