---
title: "The Koh-i-Noor: A Diamond, an Empire, and a 700-Year Argument"
slug: stories/koh-i-noor
pillar: Stories
author: Florence
published: false
...
hero_image_brief: "Queen Mary's Crown with the Koh-i-Noor at its central cross, OR a close-up of the diamond in its current cushion-cut setting. License from Royal Collection Trust if possible. 16:9. Alt text: 'The Koh-i-Noor diamond set in Queen Mary's Crown.'"
schema: Article + FAQPage
word_count: ~2,800
status: First draft. Voice, SEO, and GEO compliant. Fact-check pass recommended for specific dates and provenance claims before publication.
---
...
- [The Hope Diamond and the politics of cursed stones](/stories/hope-diamond) on the Koh-i-Noor's sister stone from the same Golconda mines
- [Lab-grown vs natural diamonds in 2026](/guides/lab-grown-vs-natural-diamonds) on what the modern diamond trade looks like for everyone else

---

*Sources: [Royal Collection Trust](https://www.rct.uk) documentation on the Koh-i-Noor and Queen Mary's Crown; William Dalrymple and Anita Anand, *Koh-i-Noor: The History of the World's Most Infamous Diamond* (Bloomsbury, 2017), the definitive modern account; Jean-Baptiste Tavernier, *Travels in India* (1676), for the seventeenth-century Mughal accounts; [British Museum](https://www.britishmuseum.org) Mughal collection documentation; contemporary press coverage of the 2023 coronation from The Guardian, The Times, and the BBC. Photography references: Royal Collection Trust, British Museum archive, Tower of London.*
